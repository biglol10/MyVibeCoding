...
| MyMacMarkdownViewer | Mac·Windows용 Markdown 편집기와 Android 읽기 전용 리더 | [MyMacMarkdownViewer](./MyMacMarkdownViewer) | [Mac 0.3.6 ZIP](https://github.com/biglol10/MyVibeCoding/raw/main/downloads/MyMacMarkdownViewer/MyMarkdownViewer-0.3.6-macOS.zip), [Windows 0.3.7 ZIP](https://github.com/biglol10/MyVibeCoding/releases/download/mymarkdownviewer-2026-09-14/MyMarkdownViewer-0.3.7-Windows-x64.zip), [Android 1.2.3 APK](https://github.com/biglol10/MyVibeCoding/raw/main/downloads/MyMacMarkdownViewer/MarkdownReader-1.2.3-Android.apk) |
...
MyMacMarkdownViewer 최신 설치본은 Mac 0.3.6, Windows 0.3.7, Android 1.2.3입니다. Mac·Windows에 현재 문서 찾기와 커서 위치 안정화를 반영했고, 각 README에서 변경 내용과 사용 방법을 확인할 수 있습니다.
...
- MyMacMarkdownViewer Mac Universal 0.3.6 ZIP: `MyMacMarkdownViewer/scripts/build.sh`
- MyMacMarkdownViewer Windows 0.3.7 포터블 ZIP: [GitHub Release](https://github.com/biglol10/MyVibeCoding/releases/download/mymarkdownviewer-2026-09-14/MyMarkdownViewer-0.3.7-Windows-x64.zip)
