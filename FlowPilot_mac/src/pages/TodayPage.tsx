...
interface TodayPageProps {
  ...
  trendSessions: ActivitySession[];
}

export function TodayPage({ sessions, summary, trendSessions }: TodayPageProps) {
  return (
    <div className="grid gap-4">
      ...
      <div className="grid grid-cols-[minmax(420px,0.95fr)_minmax(460px,1.05fr)] items-start gap-4 max-[1100px]:grid-cols-1">
        ...
        <WeeklyTrends compact sessions={trendSessions} summary={summary} />
      </div>
    </div>
  );
}
