...
APP_NAME="${MYMACFINDER_APP_NAME:-MyMacFinder}"
OUTPUT_DIR="${MYMACFINDER_OUTPUT_DIR:-$ROOT_DIR/dist}"
...
MyMacFinder personal Mac installer

Use this package only on your own Macs.

1. Double-click "Install MyMacFinder.command".
...
This personal package is not for public distribution. Public macOS distribution requires Developer ID signing and notarization.
README
